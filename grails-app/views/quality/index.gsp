            ...
            %{--Start substitution--}%
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        <label for="qualityname">QualityName<span class="required-i\ndicator">*</span></label>
                        <input type="text" name="qualityName" value="" required=""/>
                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="text-align: center;">
                <table id="userContent" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <g:each in="${userQuality}" var="quality" status="i">
                        <tr>
                            <td>${quality.qualityName}</td>
                            <td>${newgrails.ArchApplication.findById(quality.appId).appName}</td>
                            <td>${quality.remark}</td>
                            <td>
                                <div class="ad-model-edit modal fade" id="myuserModal-${quality.id}" tabindex="-1"
                                     role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <g:form resource="${quality}" method="PUT">
                                                <g:hiddenField name="version" value="${this.quality?.version}" />
                                                <fieldset class="form">
                                                    <ad:sall entityid="${quality.id}" entitytype="quality"></ad:sall>
                                                </fieldset>
                                                </div>
                                                <div class="modal-footer">
                                ...
                                <a data-toggle="modal" data-target="#myuserModal-${quality.id}">
                                    <i class="ad-edit fa fa-pencil fa-2x"></i>
                                </a>

                            </td>
                            <td>
                                <g:form resource="${quality}" method="DELETE">
                ...
                <div class="pagination">
                    <g:paginate next="Next" prev="Prev" total="${qualityCount?: 0}" />
                </div>
