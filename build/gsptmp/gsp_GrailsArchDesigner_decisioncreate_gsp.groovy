...
class gsp_GrailsArchDesigner_decisioncreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/decision/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(this.decision),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.decision)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("decision")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1441855244000L
