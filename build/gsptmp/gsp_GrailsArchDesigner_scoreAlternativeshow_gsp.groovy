...
class gsp_GrailsArchDesigner_scoreAlternativeshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/scoreAlternative/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("scoreAlternative")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.scoreAlternative)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.scoreAlternative),'method':("DELETE")],2)
printHtmlPart(17)
})
