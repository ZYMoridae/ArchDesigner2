...
class gsp_GrailsArchDesigner_alternativeshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/alternative/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("alternative")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.alternative)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.alternative),'method':("DELETE")],2)
printHtmlPart(17)
})
