...
class gsp_GrailsArchDesigner_archApplicationshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/archApplication/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("archApplication")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.archApplication)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.archApplication),'method':("DELETE")],2)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1441855236000L
