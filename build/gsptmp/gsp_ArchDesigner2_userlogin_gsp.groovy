...
class gsp_ArchDesigner2_userlogin_gsp extends GroovyPage {
...
printHtmlPart(9)
invokeTag('set','g',51,['var':("fieldEmail"),'value':("email")],-1)
printHtmlPart(10)
...
expressionOut.print(fieldPwd)
printHtmlPart(14)
invokeTag('submitButton','g',71,['name':("login"),'class':("save btn btn-primary btn-success"),'value':("Login")],-1)
printHtmlPart(15)
})
invokeTag('form','g',72,['action':("loginValidate")],2)
printHtmlPart(16)
invokeTag('javascript','asset',75,['src':("jquery.min.js")],-1)
printHtmlPart(17)
})
