...
class gsp_GrailsArchDesigner_useredit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(9)
invokeTag('hiddenField','g',22,['name':("version"),'value':(this.user?.version)],-1)
printHtmlPart(10)
invokeTag('all','f',24,['bean':("user")],-1)
printHtmlPart(11)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(12)
})
invokeTag('form','g',26,['resource':(this.user),'method':("PUT")],2)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1442233654000L
