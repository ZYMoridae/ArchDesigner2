...
class gsp_GrailsArchDesigner_stakeholdershow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/stakeholder/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("stakeholder")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.stakeholder)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.stakeholder),'method':("DELETE")],2)
printHtmlPart(17)
})
