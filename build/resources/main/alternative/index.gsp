            ...
            %{--Start substitution--}%
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        <label for="alternativename">AlternativeName<span class="required-i\ndicator">*</span></label>
                        <input type="text" name="alternativeName" value="" required=""/>
                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="text-align: center;">
                <table id="userContent" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <g:each in="${userAlternative}" var="alternative" status="i">
                        <tr>
                            <td>${alternative.alternativeName}</td>
                            <td>${newgrails.ArchApplication.findById(alternative.appId).appName}</td>
                            <td>${newgrails.Decision.findById(alternative.decisionId).decisionName}</td>
                            <td>${alternative.remark}</td>
                            <td>
                                <div class="ad-model-edit modal fade" id="myuserModal-${alternative.id}" tabindex="-1"
                                     role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <g:form resource="${alternative}" method="PUT">
                                                <g:hiddenField name="version" value="${this.alternative?.version}" />
                                                <fieldset class="form">
                                                    <ad:sall entityid="${alternative.id}" entitytype="alternative"></ad:sall>
                                                </fieldset>
                                                </div>
                                                <div class="modal-footer">
                                                    <fieldset class="buttons">
                                ...
                                <a data-toggle="modal" data-target="#myuserModal-${alternative.id}">
                                    <i class="ad-edit fa fa-pencil fa-2x"></i>
                                </a>

                            </td>
                            <td>
                                <g:form resource="${alternative}" method="DELETE">
                ...
                <div class="pagination">
                    <g:paginate next="Next" prev="Prev" total="${alternativeCount?: 0}" />
                </div>
